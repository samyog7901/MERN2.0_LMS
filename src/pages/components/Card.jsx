...
const Card = ({ book }) => {
  ...
  return (
    <div className="relative w-56 md:w-52 lg:w-60 
      ...
      <div className="absolute inset-0 
        ...
        text-white p-3 flex flex-col justify-between">
        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <Link
            to={`/book/${book._id}`}
            className="bg-amber-500 px-2 py-1 rounded text-xs 
            font-medium hover:bg-amber-600 transition"
          >
            See More
          </Link>
        </div>
