...
const Card = ({ book }) => {
  ...
  return (
    <div className="relative w-56 md:w-52 lg:w-60 bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-700 overflow-hidden hover:shadow-lg transition-transform transform hover:-translate-y-1 hover:scale-105">
      ...
      <div className="p-3">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Rs. {book.bookPrice}</p>
      </div>
    </div>
  );
};
